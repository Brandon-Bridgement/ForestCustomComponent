...
var MAX_FORCE = 10;
var iterate = function (options, NodeMatrix, EdgeMatrix) {
...
var createEdgeWeightGetter = function (name) {
 ...
 * @return {object}
 */
var helpersassign = function (target) {
    target = target || {};
 ...
 * @return {object|null}
 */
var helpersvalidateSettings = function (settings) {
 ...
 */
var helpersgraphToByteArrays = function (graph, getEdgeWeight) {
 ...
 */
var helpersassignLayoutChanges = function (graph, NodeMatrix, outputReducer) {
    var i = 0;
 ...
 * @param {Float32Array} NodeMatrix - Node matrix.
 */
var helpersreadGraphPositions = function (graph, NodeMatrix) {
    var i = 0;
 ...
 */
var helperscollectLayoutChanges = function (graph, NodeMatrix, outputReducer) {
 ...
 * @return {DOMString}
 */
var helperscreateWorker = function createWorker(fn) {
...
function abstractSynchronousLayout(assign, graph, params) {
    ...
    // Validating settings
    var settings = helpersassign({}, DEFAULT_SETTINGS, params.settings);
    var validationError = helpersvalidateSettings(settings);
    ...
    // Building matrices
    var matrices = helpersgraphToByteArrays(graph, getEdgeWeight);
    ...
    // Applying
    if (assign) {
        helpersassignLayoutChanges(graph, matrices.nodes, outputReducer);
        return;
    }

    return helperscollectLayoutChanges(graph, matrices.nodes);
}
...
FA2LayoutSupervisor.prototype.spawnWorker = function () {
    ...
    this.worker = helperscreateWorker(workerFunction);
...
FA2LayoutSupervisor.prototype.handleMessage = function (event) {
    ...
    helpersassignLayoutChanges(this.graph, matrix, this.outputReducer);
    if (this.outputReducer) helpersreadGraphPositions(this.graph, matrix);
...
FA2LayoutSupervisor.prototype.start = function () {
    ...
    // Building matrices
    this.matrices = helpersgraphToByteArrays(this.graph, this.getEdgeWeight);
